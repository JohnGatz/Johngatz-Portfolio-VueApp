  ...
  <div class="wrapper">
    <div class="bar-container">
      <div
        ...
        v-on:click="showMenu"
        :class="
          $store.getters.activeWindow == 'Menu'
      ...
      >
        ...
        >
          ...
          <div style="padding-left: 3px; font-size: 0.9rem; font-weight: bold;">
            Start
          </div>
        </div>
      </div>
      <div class="icon-bar">
        <div
          ...
          v-on:click="showBio"
          :class="[
            $store.getters.activeWindow == 'Bio' ? 'icon-depressed' : 'icon',
            $store.getters.isCloseBio ? '' : 'hidden',
          ]"
        >
        ...
        <div
          ...
          :class="[
            $store.getters.activeWindow == 'Resume' ? 'icon-depressed' : 'icon',
        ...
        <div
          alt="Resume"
          class="icon-resume "
          v-on:click="showMobileAlert"
          :class="[
            $store.getters.activeWindow == 'MobileAlert'
              ? 'icon-depressed'
              : 'icon',
