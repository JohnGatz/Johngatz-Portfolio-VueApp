...
<template>
  ...
  >
    <div
      class="about-me"
      id="container"
      :class="{ close: !$store.getters.isShownSimulator }"
    >
      <div class="top-bar" id="top-bar">
        ...
        <div class="phone-info">
          ...
          <p
            class="info"
            style="font-size: 10px; color: rgb(165, 164, 164); font-weight: 700;"
          >
            iOS 14.4
          </p>
        </div>
        ...
        <div class="iphone">
          <div v-if="!locked && !lockScreen" class="iphone-screen">
              ...
              <div class="row">
                <div class="column">
                  <a
                    ...
                    href="https://github.com/JohnGatz"
                    style="text-align: center; text-decoration: none;"
                  >
                    <img
                      style="cursor: pointer;"
                      src="../assets/iPhone-Icons/Github.webp"
                      class="iphone-grid-icon"
                    />
                    <div style="margin: 0; padding: 0;" class="subtitle">
                      GitHub
                    </div>
                  </a>
                </div>
                <div class="column">
                  <a
                    target="_blank"
                    rel="noopener noreferrer"
                    href="https://twitter.com/lizarDON2303"
                    style="text-align: center; text-decoration: none;"
                  >
                    <img
                      style="cursor: pointer;"
                      src="../assets/iPhone-Icons/Twitter.webp"
                      class="iphone-grid-icon"
                    />
                    <div style="margin: 0; padding: 0;" class="subtitle">
                      Twitter
            ...
            <div class="iphone-nav">
              <a
                target="_blank"
                rel="noopener noreferrer"
                href="https://www.instagram.com/__dontax__"
                class="iphone-icon instagram-icon"
              ></a>
              <a
                target="_blank"
                rel="noopener noreferrer"
                href="https://www.reddit.com/user/satoshigekkouga2303"
                class="iphone-icon reddit-icon"
              ></a>
              <a
                target="_blank"
                rel="noopener noreferrer"
              ...
              <a
                ...
                class="iphone-icon nossaflex-icon"
              ></a>
            </div>
          </div>
          <div v-if="locked" class="iphone-locked"></div>
          <div v-if="lockScreen" class="iphone-lock-screen">
            ...
            <div class="iphone-lock-main">
              <p
                style="color: white; font-weight: 200; font-size: 60px; margin: 0; padding: 0;"
              >
                {{ this.timeLock }}
              </p>
              <p
                style="color: white; font-weight: 500; font-size: 20px; margin: 0; padding: 0;"
              >
                {{ this.dateLock }}
              </p>
            </div>
            <div class="iphone-unlock">
              <p style="font-weight: 700; color: white;">
