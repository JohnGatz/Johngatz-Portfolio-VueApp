...
<template>
  <interact
    ...
    :class="{ fullscreen: $store.getters.isFullscreenResume }"
  >
    <div
      class="window"
      id="container"
      :class="{
        fullscreen: $store.getters.isFullscreenResume,
        close: !$store.getters.isShownResume,
      }"
    >
      <div
        class="top-bar"
        id="top-bar"
        v-on:dblclick="$store.commit('toggleFullscreenResume')"
        :class="
          $store.getters.activeWindow == 'Resume'
            ? 'top-bar'
            : 'top-bar-deactivated'
        "
      >
        ...
        <div class="triple-button">
          <div class="button-hide" v-on:click="minimizeResume">
            <span
          ...
          <div
            class="button-expand"
            v-on:click="$store.commit('toggleFullscreenResume')"
          >
            <span
      ...
      <div class="content">
        ...
        <div class="frame" @click.native="focusResume" style="z-index: 99">
          <!-- <object data="/files/John_Gutierrez_Resume.pdf#toolbar=0&navpanes=0&scrollbar=0" type="application/pdf">
                        <embed src="/files/John_Gutierrez_Resume.pdf#toolbar=0&navpanes=0&scrollbar=0" type="application/pdf" />
                    </object> -->
          <iframe
            @click.native="focusResume"
            class="frame"
            src="https://drive.google.com/file/d/17gI4NirI6LrabQsjkWP1JuWKq6LkWZes/preview"
          ></iframe>
          <div
